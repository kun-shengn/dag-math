...
from src.utils.examples import get_examples
...
def extract_boxed_content(text):
    # 1. 预处理：如果有 </think> 标记，直接切分，只保留后面的部分
    if "</think>" in text:
...
# # Case 1: 包含干扰项的思考过程
# text_with_think = r"""<think>
# I initially thought the answer was \boxed{100}, but that's wrong because...
# </think>
# The correct calculation gives \boxed{\frac{1}{2}}."""

# # Case 2: 没有思考过程（普通模型输出）
# text_normal = r"The answer is \boxed{42}."

# # Case 3: 复杂嵌套 LaTeX
# text_nested = r"The answer is \boxed{\sqrt{1+\frac{x}{y}}}."

# print(f"Case 1 (带干扰): {extract_boxed_content_robust(text_with_think)}") # 输出: \frac{1}{2}
# print(f"Case 2 (普通):   {extract_boxed_content_robust(text_normal)}")     # 输出: 42
# print(f"Case 3 (嵌套):   {extract_boxed_content_robust(text_nested)}")     # 输出: \sqrt{1+\frac{x}{y}}
